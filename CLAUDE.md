...
- **Font subsetting**: `pixi run python scripts/subset-bootstrap-icons.py` → subsets bootstrap-icons to 4 used glyphs (woff2) and strips unused CSS. Run after `quarto render`.
