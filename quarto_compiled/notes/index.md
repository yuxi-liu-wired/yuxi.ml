...
[*Visually Deriving the Wigner Rotation by Spacetime Diagrams*](wigner_rotation/wigner_rotation_complete.pdf). Obsoleted by [my post](https://yuxi.ml/essays/posts/wigner-rotation/). This is a term paper I wrote in 2018 for *Theoretical Physics*. The date in the `pdf` is the recompilation date, not the time when I actually wrote the paper.
