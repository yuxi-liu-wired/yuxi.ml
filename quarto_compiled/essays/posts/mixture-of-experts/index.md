...
Like perceptrons, logistic regression is simple, fast, and has a very elegant theory -- and [like perceptrons, logistic regression does not work if the underlying system is not linearly separable](https://yuxi.ml/essays/posts/perceptron-controversy/#interpreting-the-xor-problem).
...
* training compute: low (there was [little funding for training](https://yuxi.ml/docs/posts/1998-hans-moravec/#false-start));
