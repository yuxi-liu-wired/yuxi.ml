...
```{=html}
<div class="embed-container"><iframe src="https://fred.stlouisfed.org/graph/graph-landing.php?g=1MkcU&width=670&height=475" scrolling="no" frameborder="0" style="overflow:hidden;" allowTransparency="true" loading="lazy"></iframe></div><script src="https://fred.stlouisfed.org/assets/research/fred-graph-react/build/embed.min.js" type="text/javascript"></script><!-- interest_rates_Japan.png -->
```

The 1980s was a period of rapid change in the Japanese financial system. A complex series of events occurred during the 1985--1995 period, resulting in the bubble economy. [@noguchiBubbleEconomicPolicies1994; @hoshiJapaneseBankingCrisis1999; @kangConfidenceTrapJapans2018] To prepare the ground, several money faucets turned on:
...
* The Foreign Exchange Law was reformed in 1980, allowing freer cross-border capital flow. Foreign exchange transactions, whichwere "forbidden in principle" under the old rule, were made "free unless expressly prohibited".
* In 1987, the domestic [commercial paper](https://en.wikipedia.org/wiki/Commercial_paper) market was created, giving firms access to more uncollateralized funding.
...
A special feature of Japanese capitalism is [keiretsu](https://en.wikipedia.org/wiki/Keiretsu). Somewhat like a zaibatsu, except without biological families involved, a keiretsu is a group of banks and companies that closely cooperate over many years. The companies, as explained previously, were mainly funded by borrowing from banks. The bank--company relationship was very strong, often lasting over 30 years, and based on mutual trust. For each company, the largest provider of bank loans was called its "main bank", which cared for the company paternally. It would usually hold a lot of the stocks for the company, may send its employees to serve as directors of the company, be responsible for monitoring the company, and try to rescue the company if it is distressed. [@aokiJapaneseMainBank1994]

The degree of involvement of a main bank was quite uncommon. Indeed, if a distressed company went bankrupt or was restructured, the main bank would typically absorb a share of losses *more than* its share of loans! For example, when [Ataka & Co.](https://en.wikipedia.org/wiki/Ataka_%26_Co.) nearly collapsed in 1975, its main bank ([Sumitomo Bank](https://en.wikipedia.org/wiki/The_Sumitomo_Bank)) bore 59% of the company's losses, despite having a loan share of 15%. This "implicit convention", that the main bank must take on more than its legal duty when a company is dsitressed, may have been an implicit threat against the main banks, so that they would not shirk their implicit duty to credit-monitor the companies. [@sheardMainBankSystem1989]

As a consequence of this close collaboration, bank loans were not based on a careful [credit rating](https://en.wikipedia.org/wiki/Credit_rating) based on predicted future cash flow, but backed by land. In fact, using land as collateral was standard practice in Japanese banking, accounting for 25--30% of all collaterals during 1976--1998. This was because land was considered excellent collateral, since its nominal value never fell in the postwar period before the 1990s. [@hoshiWhatHappenedJapanese2001]
...
From the perspective of banks, the 1980s of gradual liberalization required them to change their strategy. As companies got more ways to issue debt and equity, they relied less on banks for funding. The banks thus began lending more to small and medium firms, and critically, real estate firms. [@hoshiWhatHappenedJapanese2001]
...
The end of the bubble economy came in 1990 when the stock market and the land price crashed. As good assets turned bad, it spilled out from land and stock market to the banks. The banks suffered multiple whammies: They had to write down the values of loans backed by land, of loans made directly to real estate companies. The combination of problems dragged down the banking system, and from there, the entire Japanese economy. The GDP of Japan dutifully entered the [Lost Decades](https://en.wikipedia.org/wiki/Lost_Decades), though inflation-adjusted, it did continue to grow, but the growth rate never returned to the previous level.
...
Indeed, it is a grim comedy that over the years, often the government would say it wants to make the price of apartments lower, and yet keeps allowing it to rise, and whenever it falters, immediately implements policies to make it rise again. What explains it? The short answer is that housing plays several roles that pull it in conflicting directions.
...
From the citizens' point of view, since they have no other good investment tool than the housing market, its price should keep going up as China becomes richer, else people would be very upset and cause "social instability". Indeed, brief falls in housing market reliably create social unrest, and the government would quickly make new policies that show its unwavering commitment to rising housing prices. Thus is social stability restored for another year. And this is despite the paramount leader of China repeatedly saying "[Houses are for living, not for speculation.](https://en.wikipedia.org/wiki/Houses_are_for_living,_not_for_speculation)", because when it comes down to it, social stability always triumphs over slogans.[^butt-head]
