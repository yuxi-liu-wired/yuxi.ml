...
If the Hamiltonian $H$ is a sum of kinetic and potential energies, as $H = T(p) + V(q)$, then we have the **Bopp shift** formulas:
...
This picture allows us to obtain some results by intuitively thinking about pictures.
