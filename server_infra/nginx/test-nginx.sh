...
echo ""
echo "--- Short post URLs (strip /posts/) ---"
check_status "/essays/scaling-law-by-data-manifold serves 200"                           "/essays/scaling-law-by-data-manifold"                  "200"
check_status "/logs/2025-gwern-bair serves 200"                                          "/logs/2025-gwern-bair"                                 "200"
check_status "/docs/1987-09-nick-land serves 200"                                        "/docs/1987-09-nick-land"                               "200"
check_status "/sketches/neural-network-scrapbook serves 200"                             "/sketches/neural-network-scrapbook"                    "200"
check_status "/essays/posts/scaling-law-by-data-manifold → short URL"                    "/essays/posts/scaling-law-by-data-manifold"            "301" "/essays/scaling-law-by-data-manifold"
check_status "/essays/posts/scaling-law-by-data-manifold/ → short URL"                   "/essays/posts/scaling-law-by-data-manifold/"           "301" "/essays/scaling-law-by-data-manifold"
check_status "/essays/posts/scaling-law-by-data-manifold/index.html → short URL"         "/essays/posts/scaling-law-by-data-manifold/index.html" "301" "/essays/scaling-law-by-data-manifold"
check_status "/logs/posts/2025-gwern-bair → short URL"                                   "/logs/posts/2025-gwern-bair"                          "301" "/logs/2025-gwern-bair"
check_status "/docs/posts/1987-09-nick-land → short URL"                                 "/docs/posts/1987-09-nick-land"                        "301" "/docs/1987-09-nick-land"

echo ""
echo "--- Sub-resources under short post URLs ---"
check_status "/essays/scaling-law/figure/ via short URL"                                 "/essays/scaling-law-by-data-manifold/figure/Isomap_on_Swiss_roll.png" "200"
check_status "old sub-resource path still works"                                         "/essays/posts/scaling-law-by-data-manifold/figure/Isomap_on_Swiss_roll.png" "200"

echo ""
echo "--- .md source at short post URLs ---"
check_status "/essays/scaling-law-by-data-manifold.md serves 200"                        "/essays/scaling-law-by-data-manifold.md"               "200"
check_content_type "/essays/scaling-law-by-data-manifold.md is text/plain"               "/essays/scaling-law-by-data-manifold.md"               "text/plain"
