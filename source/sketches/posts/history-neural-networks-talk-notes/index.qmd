...
This essay is written as a companion piece of a lecture on the history of neural networks. It is not exactly an essay, but more of an extended scrapbook of quotations. The lecture slides are [here](code/ML%20history%20presentation.7z).

* [Yuxi on the Wired - Cybernetic Artificial Intelligence](https://yuxi.ml/essays/posts/cybernetic-artificial-intelligence/)
* [Yuxi on the Wired - Reading Perceptrons](https://yuxi.ml/essays/posts/reading-perceptron-book/)
* [Yuxi on the Wired - The Backstory of Backpropagation](https://yuxi.ml/essays/posts/backstory-of-backpropagation/)
* [Yuxi on the Wired - The Perceptron Controversy](https://yuxi.ml/essays/posts/perceptron-controversy/)
...
Lorente de No was at the founding of cybernetics, and went to the [Macy conferences](https://en.wikipedia.org/wiki/Macy_conferences) a lot. He consistently pointed out that recurrent networks exist in the brain and is possibly responsible for transient memory. He had influenced many of the early cyberneticians, including Hebb, McCulloch, and Pitts. [@espinosa-sanchezImportanceCajalsLorente2023]
...
In proposing the reverberating circuitry, Hebb was influenced by de No [@espinosa-sanchezImportanceCajalsLorente2023]
...
>
> [@wienerNorbertWieneraLife2017, page 407]  
...
There were some neural networks in the early 1950s before Rosenblatt. See [@nilssonQuestArtificialIntelligence2009, chapter 4] for a review. The most notable one is Minsky's [SNARC](https://en.wikipedia.org/wiki/Stochastic_Neural_Analog_Reinforcement_Calculator). Details are in [Yuxi on the Wired - A Scrapbook of Neural Network Lores](https://yuxi.ml/sketches/posts/neural-network-scrapbook/index.html#neural-networks-want-to-work) and [Yuxi on the Wired - The Perceptron Controversy](https://yuxi.ml/essays/posts/perceptron-controversy/index.html#the-enigma-of-marvin-minsky).
...
Interesting results in the book: (More in [Yuxi on the Wired - The Backstory of Backpropagation](https://yuxi.ml/essays/posts/backstory-of-backpropagation/index.html#frank-rosenblatt))
...
More information in [Yuxi on the Wired - The Backstory of Backpropagation](https://yuxi.ml/essays/posts/backstory-of-backpropagation/index.html#bernard-widrow-and-marcian-hoff).
...
See more of these amusing stories at [Yuxi on the Wired - A Scrapbook of Neural Network Lores](https://yuxi.ml/sketches/posts/neural-network-scrapbook/#neural-networks-want-to-work).
...
See [Yuxi on the Wired - The Perceptron Controversy](https://yuxi.ml/essays/posts/perceptron-controversy/) for details.

### 30 years of people refusing to use gradient descent

See [Yuxi on the Wired - The Backstory of Backpropagation](https://yuxi.ml/essays/posts/backstory-of-backpropagation/).
...
>
> [@hardyMathematiciansApology1940]  
