...
AM was his 1976 PhD thesis project, and it was one of many "automated discovery" systems in the 1970s -- the only one still remembered nowadays. Though neural networks and other "self-organized" machine learning methods had mostly [died out in the 1960s](https://yuxi.ml/essays/posts/perceptron-controversy/), machine learning did not die, and indeed, was going through a logical spring, under the banner of "automated discovery".
...
If this sounds familiar, it is because this Lenat had the same idea as Marvin Minsky, a friend of his,[^minsky-anecdote] and he was writing in 1984, at the second coming of neural networks. Minsky would soon write his *Society of Mind* in 1986, which the Cyc project resembled, then [re-reject neural networks by writing a long epilogue in 1988](https://yuxi.ml/essays/posts/perceptron-controversy/#minsky-and-papert-struck-back) to his infamous *Perceptrons* (1969), often blamed for the first neural network winter. Indeed, Lenat's objection to neural networks was essentially the same as Minsky's, if you compare that with Minsky's epilogue. Lenat's approach to Cyc was the same as the Society of Mind of Minsky. Reciprocating, Minsky had often called the field of AI "brain-dead", holding Lenat's Cyc as the only one worth mentioning. [@baardAIFounderBlasts2003]
...
![The user interface of Cyc as of 1989. It has a similar style as EURISKO's, and thus it probably ran on the Interlisp OS. It was described as being able to run on "[Symbolics Machines](https://en.wikipedia.org/wiki/Symbolics) of all sorts, [Sun3](https://en.wikipedia.org/wiki/Sun-3)s, [TI Explorer II+s](https://en.wikipedia.org/wiki/Texas_Instruments_Explorer), [MacIIs (with Ivory boards)](https://en.wikipedia.org/wiki/MacIvory), and (with some conversion) [VAX machines](https://en.wikipedia.org/wiki/VAX)". These were the dominant high-end Lisp computers of the late 1980s: dedicated Lisp Machines (Symbolics, TI), powerful Unix workstations (Sun), high-end PC enhanced with Lisp hardware (MacIvory), and minicomputers (VAX). [@lenatBuildingLargeKnowledgebased1989, figure 8-1]](figure/Cyc_GUI_1989.png)
...
![A sketch of how to reason by backward-chaining together triples in a semantic web. Figure from [@wallichSiliconBabies1991].](figure/Cyc_triple_reasoning.png)
...
In America, at least before the Deep Learning era, the government funded most large-scale efforts in AI, usually in the context of military and intelligence applications. This was true for the Cyc project. Indeed, it initiated in 1984-07 within the [Microelectronics and Computer Consortium](https://en.wikipedia.org/wiki/Microelectronics_and_Computer_Technology_Corporation) (MCC), which, like the [Strategic Computing Initiative](https://en.wikipedia.org/wiki/Strategic_Computing_Initiative),<!-- todo: link to SCI --> was formed in reaction to the threat of the Japanese [Fifth Generation Computer Systems](https://en.wikipedia.org/wiki/Fifth_Generation_Computer_Systems) project<!-- todo: link to SCI#FGCS instead -->. Though not *directly* funded by the government, its head was [Bobby Inman](https://en.wikipedia.org/wiki/Bobby_Ray_Inman), who had previously held high positions in the Navy, the [NSA](https://en.wikipedia.org/wiki/National_Security_Agency), and the [CIA](https://en.wikipedia.org/wiki/Central_Intelligence_Agency), so draw your own conclusion.
...
* [DoD](https://en.wikipedia.org/wiki/United_States_Department_of_Defense), in 2001, to "clean dataset". [@thompsonKnowItAllMachine2001]
* Glaxo Wellcome, [DEC](https://en.wikipedia.org/wiki/Digital_Equipment_Corporation), IBM, and [United Healthcare](https://en.wikipedia.org/wiki/UnitedHealth_Group), sometime before 1997, for unknown purposes. [@portDuelingBrainscapesArtificial1997]
  ...
  *  For Glaxo Wellcome, and United Healthcare, it was probably for the purpose described in the next entry.
* [GlaxoSmithKline](https://en.wikipedia.org/wiki/GSK_plc), before 2001, to "clean dataset" [@thompsonKnowItAllMachine2001], probably meaning to manage a thesaurus of pharmaceutical chemicals and health-care words. ([Source](https://web.archive.org/web/20130720051038/http://www.cyc.com/enterprise-solutions/success-stories/pharmaceutical-thesaurus-management)) Probably started in 1997. [@portDuelingBrainscapesArtificial1997]
  * Because GlaxoSmithKline was formed by a merger of two giant pharmaceutical companies in 2000, one of which was the aforementioned Glaxo Wellcome, it's almost certain that the use of Cyc by Glaxo Wellcome and by GlaxoSmithKline were identical.
...
* The CIA and the DoD, at an unknown time, for unspecified purposes, though probably to identify terrorist threats in connection with the Terrorist Knowledge Base. [@shilohHeTaughtAI2023]
...
* Cleveland Clinic, starting in 2007, to parse clinician queries into database queries and returns the result, [detailed below](#sec-cleveland-clinic). [@lenatHarnessingCycAnswer2010; @pierceSemanticDBSemanticWeb2012]
...
Looking at the list, we see that much of Cycorp funding came from the American intelligence community, especially between 2001 and 2010, during the heights of the [War on Terror](https://en.wikipedia.org/wiki/War_on_terror), as the American state struggled to expand its sovereign eye over the sprawling cyberspace. Indeed, one of the early success was when it "predicted anthrax might be sent through the mail six months before it happened", based on "trove of knowledge about past terrorist activities, tactics, and weapons" it acquired as part of its \$9.8 million grant from the Defense Department's Information Awareness Office. [@hawkinsPredictingTerroristsNext2003] Though the success did not help anyone, it was a great advertisement.[^explosive-dolphins] Corroborating, Lenat in a [2006 Google Talk](https://youtu.be/gAtn-4fhuWA?si=gAQ-TISZxxgeD1VN&t=1856) showed screenshots of Cyc answering "Which American city would be most vulnerable to an anthrax attack during summer?". (The answer was "Phoenix".)
...
### Cleveland Clinic {#sec-cleveland-clinic}
...
[^cleveland-clinic-cyc]: I could only find one paper, [@lenatHarnessingCycAnswer2010], that contains substantial public information about this collaboration. Therefore, I can only confirm that Cyc had been used in Cleveland Clinic during 2007--2010. It may have lasted to at least 2021, since [@cycorpCycTechnologyOverview2021] still cited this application.
...
In a [presentation in 2019](https://web.archive.org/web/20210430003227/https://files.gotocon.com/uploads/slides/conference_13/724/original/AI_GOTO%20Lenat%20keynote%2030%20April%202019%20hc.pdf), Lenat claimed it required 120K new assertions for the Cleveland project, or 0.5% of the total knowledge base (so at this point, Cyc had 24M assertions). However, 95% of the assertions that Cyc called up for answering queries for the project required knowledge Cyc already had, a great advertisement for large knowledge reuse.
...
In [@lenatThresholdsKnowledge1991], a paper coauthored with [Edward Feigenbaum](https://en.wikipedia.org/wiki/Edward_Feigenbaum), Lenat gave the most comprehensive statement for where he stands philosophically, which he held onto for the rest of his life:
...
- Explicit Knowledge Principle. While knowledge may be compiled to opaque lumps of code for efficiency, there should always be a declarative version of that, so that it can be subject to meta-reasoning.
...
- Empirical Inquiry Hypothesis. The most profitable way to investigate AI is to embody the investigator's hypotheses in programs, and gather data by running the programs. These programs must be capable of surprising the investigator, and surprises suggest revisions that start the cycle over again.
...
- The Coherence Hypothesis. Whenever two large internally consistent chunks C1, C2 are similar, their heuristics and analogies should cohere; e.g., if the "going up" metaphor usually means "getting better" for C1, then either the "going up" metaphor means "getting better" also in C2, or it does not occur in C2.
...
* Creating tiny morsels of little expert systems, and hoping that bit by bit, AGI would emerge out of that. Remember that plateau-hopping requires breadth. Without an overarching plan, they will not fit together, like how the 1980s expert systems could never talk to each other.
...
Indeed, Lenat had often claimed that the Winograd schema challenge is a touchstone for true language understanding, something that would prove that Cyc really understands, and unmask the other systems' veneers of intelligence. And how must the Winograd schema challenge be solved? Lenat's solution is to go to the pinnacle of the triangle -- interlingua, the King of Kings, the Language among Languages, a completely universal conceptual representation for all that humans might wish to mean by their speech.
...
On the topic of interlingua, there was a certain Russian machine-translation company, [ABBYY](https://en.wikipedia.org/wiki/ABBYY)<!-- todo: link to ABBYY -->, that was almost a twin of Cycorp. Whereas Cycorp began building an ontology for the common sense world since 1984, spent \$200M, and got stuck on NLU since around 2010, ABBYY began building an interlingua-based machine translation system since the 1990s, and spent over \$80M. By the early 2010s, they realized that they could not compete with Google statistical machine translation, and pivoted to doing NLU with semantic graph technology based on the knowledge base they produced for the sake of interlingua. [@skorinkinABBYYsBitterLesson2024] Indeed, interlingua-based machine translation projects used to be the common approach, but mostly went extinct after the rise of statistical machine translation in the 1990s [@hutchinsMachineTranslationHistory2023].

I suspect that it is not simply the case that, once given a better English → CycL translator, Cyc would finally begin learning, but in fact, much knowledge in sentences doesn't translate to interlingua.[^interlingua-latent-space] If the failures of all interlingua machine translation systems is not enough evidence, then consider some more facts about Cyc's NLU:

[^interlingua-latent-space]: Alternatively, perhaps this interlingua exists, but it is not symbolic-logical, but vector-algebraic. Indeed, the successful neural machine translation systems' latent spaces may be that consummate interlingua so devoutly wished for, but such an interlingua is very far from what you'd see in Cyc or ABBYY.
...
* [@sarjantAllYouCan2009] increased the common-sense knowledge in ResearchCyc by 30% in 2009, by parsing Wikipedia into CycL. The technique was guess-and-verify, where the guess was done by simplistic methods like regex parsing, [infobox](https://en.wikipedia.org/wiki/Help:Infobox) pairing, etc, and the verification was done by Cyc itself.
...
* Only *one* of the commercial applications of Cyc may have required NLU.
...
The [minimal description length of English](https://yuxi.ml/essays/posts/perplexity-turing-test/#entropy-of-natural-languages) is about 0.8 bits per character (bpc), and each English sentence contains about 100 characters, giving 80 bits of incompressible information. Since there are 27 characters (we are just counting the 26 lowercase letters and the whitespace), this means that the compressible information is about $log_2 27 - 0.8 = 4.0$ bpc.

We can think of writing as a process of selection: Out of all the possible letters you can pick next, you picked this *particular* letter, and you do it again and again. Intelligence is good selection, the careful elimination of bad choices. In this particular case, the bad choices to be eliminated as we showed is ~4.0 bpc. So, we can say that the "bit rate of intelligence" is 4.0 bpc.

Now, one might argue that the last bit is the deepest, but it is hard to square the two claims:

* Self-organized NNs could compress natural text to a bit rate of ~1.0 bpc, so they already compress 3.8 bpc, and thus capture 3.8/4.0 = 95\% of the bit rate of intelligence.
* Self-organized NNs don't understand.

Stated in another way, this means 95\% of the selection that humans perform while writing is mindless, mere remembering and espousing without understanding or inferring. This is even harder to square with Lenat's assertion that 99\% of language understanding is pragmatics, which self-organized NNs don't have. [@lenatSometimesVeneerIntelligence2017]

Does this mean that 94% of pragmatics is mindless, or are we going to just throw out the information-theoretic understanding of language as another incommensurable paradigm shift? It would fit the theme of Cyc. Indeed, they had long excised the remnants of probabilistic reasoning when they removed [certainty factors](https://en.wikipedia.org/wiki/Mycin) at some point before 1989, since they found it inadequate compared to reasoning by logical unification. [@guhaReCycLingPaper1993] Cry "Kuhnian" and let slip the dogs of logic...
...
But that's enough about unverified rumors, and I apologize. It would have been better for epistemic hygiene if there was more open information about Cycorp. Let's turn to a Cycoanalysis of Lenat's rhetorics, which is more well-documented.
...
In the 1980s, like other expert systems people, he aimed his rejection at the previous logical AI methods exemplified by Simon and Newell. Logical AI was a dream that a graduate student might build an AGI during a thesis period, if only they knew the "Maxwell's equations of thinking". Of course, such attempts failed, because there are no such equations. He took a little effort towards rejecting the *other* logical AI approach -- the cognitive psychology approach. Exemplified by [@newellHumanProblemSolving1972], this method constructs models that reproduced every little detail of how humans really perform in psychometric experiments, such as their reaction times, their uhhs and oopses. Admitting its interest to psychologists, he considered it a distraction for machine intelligence.
...
3. Therefore, AI systems machine-learned from scratch are idiot savants at most.
...
Lenat died in 2023, unmourned on [Lucid AI](https://lucid.ai/) and [Cycorp](https://cyc.com/), who still proudly advertise their product differentiation to this day.
...
* [Twitter](https://x.com/layer07_yuxi/status/1907179435079717134)
* [r/mlscaling](https://old.reddit.com/r/mlscaling/comments/1juosnn/cyc_obituary_for_the_greatest_monument_to_logical/)
