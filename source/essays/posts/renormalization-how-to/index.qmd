...
![When an Ising model is at the critical temperature $T_c$, coarse-graining would not end up with all-black or all-white, but would have the same amount of details no matter how much we coarse-grain. [@sethnaCourse6Crackling2007, figure 13].](figure/ising%20model.png)
...
[^elephants-dont-play-chess]: Nor do they play chess. [@brooksElephantsDontPlay1990]
