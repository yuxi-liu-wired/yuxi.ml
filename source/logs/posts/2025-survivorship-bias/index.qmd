...
But what we really want to know are of course the B-17 and the B-24, since those were the ones most mass-produced. What did the Germans know about them?
...
Other than the aircraft story, Wald most famous for devising the [sequential probability ratio test](https://en.wikipedia.org/wiki/Sequential_probability_ratio_test). It has been mentioned before in [*Predicting AGI by the Turing Test*](https://yuxi.ml/essays/posts/perplexity-turing-test/#turing-test-as-statistical-hypothesis-test).
...
> 
> [@bernsteinMarvinMinskysVision1981]
