...
!["The position embedding is inserted somewhere in the middle." In [this diagram](https://en.wikipedia.org/wiki/File:DeepSeek_MoE_and_MLA_(DeepSeek-V2).svg), it is shown as the "apply RoPE". It is really weird. I read through [Jianlin Su's explanation](https://yuxi.ml/docs/posts/2024-05-13-multi-latent-attention/) several times, but still did not understand.](figure/DeepSeek_MoE_and_MLA_(DeepSeek-V2).svg)
